...
parser.add_argument('--pretrain_data', type=str, default='imagenet', choices=['imagenet', 'say', 'tabula_rasa', 'saycam_0.01', 'saycam_0.1'], help='pretrain data')
parser.add_argument('--finetune_data', type=str, default='brady_1_study', choices=['brenden_1_study', 'brenden_2_study', 'brady_1_study', 'brady_2_study', 'konkle_1_study', 'konkle_2_study'], help='finetune data')
...
model_name = '{}l_{}h_{}e_{}b_{}d_{}lr_{}op_{}ep_{}seed_{}pt_{}ft.pt'.format(
    args.n_layer, args.n_head, args.n_embd, args.world_size * args.batch_size, args.d_img, 
    args.lr, args.optimizer, args.epochs, args.seed, args.pretrain_data, args.finetune_data
    )
...
if args.data_cache and os.path.exists(args.data_cache):
    ...
    train_dataset = ImageDataset(train_data, args.d_img, checkpoint['clusters'])
